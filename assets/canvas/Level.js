...
var groupSalesVolume = 0, personalSalesVolume = 0, percentDone, progress, numberDistributors = 0, numberCustomers = 0, congrats, customerArray = [];
/**
 * Level.
 */
function Level() {
...
Level.prototype.update = function() {
  ...
  var customerOverlap = this.physics.arcade.overlap(this.fPlayer, this.fCustomers, collectCustomer, null, this);
	if (!congrats.visible)
	{
...
function collectCustomer(player, customer)
{
  customer.kill();
  numberCustomers++;
}