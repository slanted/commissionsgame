...
var groupSalesVolume = 0, personalSalesVolume = 0;
/**
 * Level.
 */
function Level() {
...
Level.prototype.create = function () {
  ...
  gsvText = this.add.text(0, 0, 'Group Sales Volume: 0', {fontSize: '16px', fill: '#000'});
  gsvText.fixedToCamera = true;
  gsvText.cameraOffset.setTo(0,0);

  psvText = this.add.text(300, 0, 'Personal Sales Volume: 0', {fontSize: '16px', fill: '#000'});
