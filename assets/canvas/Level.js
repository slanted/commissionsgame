...
var groupSalesVolume = 0, personalSalesVolume = 0, percentDone, progress, numberDistributors = 0, numberCustomers = 0, congrats, customerArray = [], numberCollectedCustomers;
/**
 * Level.
 */
function Level() {
...
Level.prototype.create = function () {
  ...
  var customer = _customers.create(70, 500, 'customer');
  customer.body.gravity.y = 10;
  customer.body.bounce.y = 0.6 + Math.random() * 0.2;
...
Level.prototype.update = function() {
  ...
  // progress bar
  progress.width += .1;
  if (numberDistributors >= 1 && groupSalesVolume >= 100)
	{
...
Level.prototype.collectCustomer = function(player, customer)
{
  customer.kill();
  numberCustomers++;
  console.log("collectCustomer");
  var customer = this.fCustomers.create(1150, 0, 'customer');
  customer.fixedToCamera = true;
  customer.cameraOffset.setTo(1125,0);
